...
func resourceArmKeyVaultIssuer() *schema.Resource {
	return &schema.Resource{
		Create: resourceArmKeyVaultIssuerCreate,
		Read:   resourceArmKeyVaultIssuerRead,
		Update: resourceArmKeyVaultIssuerUpdate,
		Delete: resourceArmKeyVaultIssuerDelete,
...
func resourceArmKeyVaultIssuerCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceArmKeyVaultIssuerRead(d, meta)
}

func resourceArmKeyVaultIssuerUpdate(d *schema.ResourceData, meta interface{}) error {
...
func resourceArmKeyVaultIssuerRead(d *schema.ResourceData, meta interface{}) error {
	keyVaultClient := meta.(*clients.Client).KeyVault.VaultsClient
	client := meta.(*clients.Client).KeyVault.ManagementClient
...
func resourceArmKeyVaultIssuerDelete(d *schema.ResourceData, meta interface{}) error {
	keyVaultClient := meta.(*clients.Client).KeyVault.VaultsClient
	client := meta.(*clients.Client).KeyVault.ManagementClient
